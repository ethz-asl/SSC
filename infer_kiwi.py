...
class ROSInfer:
    ...
    def callback(self, depth_image):
        ...
        if self.args.model == 'palnet' or self.args.model == 'palnet_ours':
    ...
    def _load_arguments(self):
        ...
        parser.add_argument('--input_topic_name', type=str, default='/depth/image_raw',
                            help='depth image topic to subscribe to (default: /depth/image_raw)')
        ...
        parser.add_argument('--model', type=str, default='palnet_ours', choices=['ddrnet', 'palnet', 'palnet_ours'],
                            help='model name (default: palnet_ours)')
