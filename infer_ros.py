...
def load_data_from_depth_image(depth, cam_pose, max_depth=8, cam_k=[[320, 0, 320], [0, 320, 240], [0, 0, 1]]):
    """
...
def main():
    ...
    if args.resume:
        load_network(args.resume)
    else:
        raise Exception("Please provide path of Trained model!")

    # subscribe to depth image from the simulation
