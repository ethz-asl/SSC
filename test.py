...
parser.add_argument('--model', type=str, default='ddrnet', choices=['ddrnet', 'aicnet', 'grfnet', 'palnet', 'lwddrnet', 'palnet_ours'],
...
def main():
    ...
    test()
    print('Testing finished in: {}'.format(datetime.datetime.now() - train_time_start))
